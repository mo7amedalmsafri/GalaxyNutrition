...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'إنشاء حساب' (Create account) link (element index 27) to open the registration page.
        # link "إنشاء حساب"
        elem = page.locator("xpath=/html/body/main/div/div[2]/p/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the registration form fields (email, password, confirm password) with the provided credentials and click the 'إنشاء الحساب' submit button to attempt registration.
